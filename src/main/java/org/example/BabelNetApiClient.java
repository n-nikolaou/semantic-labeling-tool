...
public class BabelNetApiClient extends SemanticApiClient {
    ...
    BabelNetApiClient(TextProcessor textProcessor) throws ExecutionException, InterruptedException {
        super(textProcessor);
        ...
        while (iterator.hasNext()) {
            ...
            wordsId.add(getSynsetId(iterator.next(), lemmas.get(index), textProcessor.getTags()[index]));
        }
